                    ...
                    <div class="w-25percent flex items-center justify-end mr-20 lg:w-60percent lg:mr-0">
                        <div class="flex items-center justify-end">
                            ...
                            <a class="btn btn-solid text-white bg-gray-600 rounded-100 ml-10 text-15 font-medium bg-bg hover:text-black hover:bg-white module-btn-sm w-200"
                                href="/courses"><span class="btn-txt" data-text="Login">Dashboard</span></a>
        ...
        <main class="content">
            <div id="lqd-contents-wrap">
                <section class="lqd-section banner pt-140 pb-200 transition-all bg-transparent text-white-50 relative"
                    id="banner" style="background-image: linear-gradient(120deg, #c9bffb 0%, #182ed8 100%);">
                                ...
                                <div class="relative flex flex-col text-center">
                                    ...
                                    <div class="relative z-2">
                                        <div class="ld-fancy-heading relative animation-element">
                                            <h1 class="ld-fh-element relative lqd-highlight-custom lqd-highlight-custom-2 mb-0/35em text-white text-70"
                                                ...
                                                <mark class="lqd-highlight"><span
                                                        class="lqd-highlight-txt">School</span>
                                                ...
                                                <span class="txt-rotate-keywords"><span
                                                        class="txt-rotate-keyword active"><span>Web Development.</span>
                                                    </span><span class="txt-rotate-keyword"><span>UI/UX Design.</span>
                                        ...
                                        <div class="mb-35 relative animation-element"><a
                                                ...
                                                data-lity="#contact-modal" href="#contact-modal"><span
                                                    ...
                                                    data-split-text="true">Gabung Sekarang — <span>Waktu
                                                        Terbatas</span>
                                    ...
                                    <div class="w-full flex flex-wrap">
                                        <div class="w-20percent sm:w-50percent p-10 module-client animation-element">
                                            <img alt="spotify" class="opacity-100 hover:opacity-100 transition-all"
                                                height="23" src="assets/images/demo/start-hub-2/3D/php.png"
                                                width="45">
                                        </div>
                                        <div class="w-20percent sm:w-50percent p-10 module-client animation-element">
                                            <img alt="nike" class="opacity-100 hover:opacity-100 transition-all"
                                                height="23" src="assets/images/demo/start-hub-2/3D/java.png"
                                                width="45">
                                        </div>
                                        <div class="w-20percent sm:w-50percent p-10 module-client animation-element">
                                            <img alt="amd" class="opacity-100 hover:opacity-100 transition-all"
                                                height="17" src="assets/images/demo/start-hub-2/3D/python.png"
                                                width="45">
                                        </div>
                                        <div class="w-20percent sm:w-50percent p-10 module-client animation-element">
                                            <img alt="apper" class="opacity-100 hover:opacity-100 transition-all"
                                                height="19" src="assets/images/demo/start-hub-2/3D/css.png"
                                                width="45">
                                        </div>
                                        <div class="w-20percent sm:w-full p-10 animation-element"><img alt="logitech"
                                                class="opacity-100 hover:opacity-60 transition-all" height="25"
                                                src="assets/images/demo/start-hub-2/3D/html.png" width="45">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row text-center justify-center">
                            <div class="col col-12 col-md-8 col-lg-6 mb-70 text-center relative p-0 module-title"
                                ...
                                data-custom-animations="true">
                                <div class="ld-fancy-heading relative animation-element">
                                    <h2 class="ld-fh-element m-0 inline-block relative">Kursus Coding Seputar</h2>
                                </div>
                                <div class="ld-fancy-heading relative animation-element">
                                    <h2 class="ld-fh-element relative ld-gradient-heading bg-transparent leading-1/2em mb-0/5em"
                                        ...
                                        <span class="txt-rotate-keywords"><span class="txt-rotate-keyword active">Web
                                                Development.</span> <span class="txt-rotate-keyword">Desktop
                                                Development.</span> <span class="txt-rotate-keyword">UI/UX
                                                Design.</span><span class="txt-rotate-keyword">Mobile
                            ...
                            <div class="col col-12 col-md-4 mb-30 border-right border-lightgray relative sm:border-0">
                                <div class="px-35 transition-all relative lg:p-0">
                                    <div class="relative iconbox flex flex-grow-1 relative flex-col iconbox-default">
                                        ...
                                        <div class="contents">
                                            <h3 class="text-20 mb-0/5em lqd-iconbox-heading">IT Courses</h3>
                                            <p>Menyediakan kursus IT yang terstruktur dengan materi yang disusun
                                                secara logis dan progresif, mulai dari pemula hingga tingkat lanjutan
                                                dengan dukungan sumber daya dan bimbingan profesional.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col col-12 col-md-4 mb-30">
                                <div class="px-35 transition-all relative lg:p-0">
                                    <div class="relative iconbox flex flex-grow-1 relative flex-col iconbox-default">
                                        ...
                                        <div class="contents">
                                            <h3 class="text-20 mb-0/5em lqd-iconbox-heading">Interactive Instruktur
                                            </h3>
                                            <p>Instruktur yang berdedikasi dan berpengetahuan luas, siap untuk
                                                membimbing melalui proses pembelajaran dengan cara yang menarik dan
                                                interaktif.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="lqd-section services pt-45 pb-55 bg-transparent"
                    ...
                    data-custom-animations="true" id="services"
                    style="background-image: linear-gradient(180deg, #fff 47%, #F0EEFD 47%);">
                    <div class="background-overlay bg-transparent transition-all opacity-100"
                        style="background-image: linear-gradient(0deg, rgb(255, 255, 255) 0, rgba(71, 53, 122, 0) 55%);">
                    </div>
                    <div class="container">
                        <div class="row justify-center">
                            ...
                            <div class="col col-12 col-md-6 p-15">
                                <div
                                    ...
                                    <div class="contents">
                                        <h3 class="text-20 lqd-iconbox-heading"><span>Bootcamp PHP</span>
                                            <svg class="inline-block" height="32" viewbox="0 0 12 32"
                                        ...
                                        <p>Instruktur : Bagas Suka Bapak.</p>
                                        <p>Durasi : 10 Jam</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col col-12 col-md-6 p-15">
                                <div
                                    ...
                                    <div class="contents">
                                        <h3 class="text-20 lqd-iconbox-heading"><span>Bootcamp Java</span>
                                            <svg class="inline-block" height="32" viewbox="0 0 12 32"
                                                width="12" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"
                            ...
                            <div class="col col-12 col-md-6 p-15">
                                <div
                                    ...
                                    <div class="iconbox-icon-wrap mr-35">
                                        <div class="text-34 iconbox-icon-container inline-flex">
                                            <img alt="spotify" class="opacity-100 hover:opacity-100 transition-all"
                                                height="23" src="assets/images/demo/start-hub-2/3D/html.png"
                                                width="45">
                                        </div>
                                    </div>
                                    <div class="contents">
                                        <h3 class="text-20 lqd-iconbox-heading"><span>Bootcamp HTML</span>
                                            <svg class="inline-block" height="32" viewbox="0 0 12 32"
                                                width="12" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"
                            ...
                            <div class="col col-12 col-md-6 p-15">
                                <div
                                    ...
                                    <div class="iconbox-icon-wrap mr-35">
                                        <div class="text-34 iconbox-icon-container inline-flex">
                                            <img alt="spotify" class="opacity-100 hover:opacity-100 transition-all"
                                                height="23" src="assets/images/demo/start-hub-2/3D/css.png"
                                                width="45">
                                        </div>
                                    </div>
                                    <div class="contents">
                                        <h3 class="text-20 lqd-iconbox-heading"><span>Bootcamp CSS</span>
                                            <svg class="inline-block" height="32" viewbox="0 0 12 32"
                                                width="12" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M8.375 16L.437 8.062C-.125 7.5-.125 6.5.438 5.938s1.563-.563 2.126 0l9 9c.562.562.624 1.5.062 2.062l-9.063 9.063c-.312.312-.687.437-1.062.437s-.75-.125-1.063-.438c-.562-.562-.562-1.562 0-2.125z"
                            ...
                            {{-- <div class="concon">
                                <div class="slaiider owl-carousel">
                                    @foreach ($materi as $mat)
                                        <div class="kartuguru">
                                            <div class="gambarrrr"><img src="{{ asset('uploaded_files/' . $mat->thumb) }}" alt=""></div>
                                            <div class="isianya">
                                                <div class="judulnya">{{ $mat->title }}</div>
                                                <div class="sub-judulnya">{{ $mat->tutor->profession }}</div>
                                                <a href="">
                                                    <div class="tutorcik">
                                                        <img src="{{ asset('uploaded_files/' . $mat->tutor->image) }}" alt="">
                                                        <p>{{ $mat->tutor->name }}</p>
                                                    </div>
                                                </a>
                                                <p>{{ $mat->description }}</p>
                ...
                <section class="lqd-section text-lg">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col col-12">
                                <div class="whitespace-nowrap ld-fancy-heading relative" data-parallax="true"
                                    data-parallax-from="{&quot;x&quot;: &quot;1vw&quot;}"
                                    data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom+=0px top&quot;}"
                                    data-parallax-to="{&quot;x&quot;: &quot;-20vw&quot;}">
                                    <h2 class="ld-fh-element mb-0/5em inline-block relative">Codinggo School
                                    </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        <div class="row items-end">
                            <div class="col col-12 col-md-6"
                                data-ca-options="{&quot;animationTarget&quot;: &quot;p&quot;, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;45px&quot;, &quot;rotationY&quot; : 65, &quot;opacity&quot; : 0, &quot;transformOrigin&quot;: &quot;100% 50% 0px&quot;} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;rotationY&quot; : 0, &quot;opacity&quot; : 1, &quot;transformOrigin&quot;: &quot;50% 50% 80px&quot;}}"
                                data-custom-animations="true">
                                {{-- <div class="mb-100 mr-90 lg:mr-0 sm:m-0">
                                    <p class="text-22 font-medium leading-1/15em mb-1/15em"><span
                                            class="text-blue-400">Lorem ipsum dolor sit amet consectetur adipisicing
                                            elit. Dignissimos suscipit molestias error!,</span>
                                        <span>Lorem ipsum dolor sit amet.</span>
                                    </p>
                                </div> --}}
                            </div>
                            <div class="col col-12 col-md-6 sm:order-first"
                                data-ca-options="{&quot;animationTarget&quot;: &quot;figure, h5, .btn&quot;, &quot;startDelay&quot; : 200, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;45px&quot;, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;opacity&quot; : 1}}"
                                data-custom-animations="true">
                                    ...
                                    <div class="w-315 text-center">
                                        <div class="lqd-imggrp-single block relative" data-float="ease-in">
                                            <div class="lqd-imggrp-img-container inline-flex relative sm:w-50percent">
                                                <figure class="w-full relative"><img alt="3D shape float"
                                                        height="881"
                                                        src="assets/images/demo/start-hub-2/3D/Group-35760.png"
                                                        width="634"></figure>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="w-full relative -mt-200 mb-0 relative z-1 lg:mr-0"
                                        data-parallax-from="{&quot;x&quot;: &quot;-70px&quot;, &quot;y&quot;: &quot;-30px&quot;}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom+=0px top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;-90px&quot;, &quot;y&quot;: &quot;-50px&quot;}">
                                        <div class="w-350 flex mx-auto">
                                            <div class="w-full flex">
                                                <div class="has-bg bg-center bg-cover transition-all py-25 px-35 rounded-10"
                                                    style="background-image: url('assets/images/demo/start-hub-2/bg/bg.jpg');">
                                                    <div class="ld-fancy-heading relative">
                                                        <h5 class="ld-fh-element mb-0/5em inline-block relative">Sosial
                                                            Media Kami</h5>
                                                    </div>
                                                    <a class="btn btn-naked btn-icon-right btn-hover-reveal text-secondary uppercase text-12 font-semibold tracking-1/5 hover:text-secondary"
                                                        href="#"><span class="btn-txt"
                                                            data-text="Learn more">Selengkapnya</span> <span
                                                            class="btn-icon"><i aria-hidden="true"
                                                                class="lqd-icn-ess icon-ion-ios-arrow-forward"></i></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <section class="lqd-section experiences pt-45 pb-95 relative">
                    <div class="container">
                        <div class="row">
                            <div class="w-40percent flex lg:w-full p-0"
                                data-ca-options="{&quot;animationTarget&quot;: &quot;img&quot;, &quot;startDelay&quot; : 200, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;45px&quot;, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;opacity&quot; : 1}}"
                                data-custom-animations="true">
                                <div class="w-full flex flex-wrap items-center justify-center relative p-15">
                                    <div class="w-auto absolute top-0 module-img-1" data-parallax="true"
                                        data-parallax-from="{&quot;x&quot;: &quot;45px&quot;}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom+=0px top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;0px&quot;}"><img alt="3D Shape dots"
                                            height="65" src="assets/images/demo/start-hub-2/3D/patt.svg"
                                            width="90"></div>
                                    <div class="w-auto absolute top-0 module-img-2" data-parallax="true"
                                        data-parallax-from="{&quot;x&quot;: &quot;48px&quot;, &quot;y&quot;: &quot;200px&quot;}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom-=100% top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;0px&quot;, &quot;y&quot;: &quot;0px&quot;}">
                                        <img alt="experiences" height="121"
                                            src="assets/images/demo/start-hub-2/experience/thumb-6.png"
                                            width="121">
                                    </div>
                                    <div class="w-auto absolute -top-10percent module-img-3" data-parallax="true"
                                        data-parallax-from="{&quot;x&quot;: &quot;-90px&quot;, &quot;y&quot;: &quot;230px&quot;}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom-=100% top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;0px&quot;, &quot;y&quot;: &quot;0px&quot;}">
                                        <img alt="experiences" height="127"
                                            src="assets/images/demo/start-hub-2/experience/Group-30499%402x.png"
                                            width="127">
                                    </div>
                                    <div class="w-auto relative z-1 module-img-4" data-parallax="true"
                                        data-parallax-from="{&quot;y&quot;: &quot;95px&quot;}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom-=100% top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;0px&quot;, &quot;y&quot;: &quot;0px&quot;}">
                                        <img alt="experiences" height="213"
                                            src="assets/images/demo/start-hub-2/experience/deecfe7e5b08bc77341f2b4318f55340.png"
                                            width="213">
                                    </div>
                                    <div class="w-auto absolute bottom-25percent z-1 module-img-5"
                                        data-parallax="true"
                                        data-parallax-from="{&quot;x&quot;: &quot;-80px&quot;, &quot;y&quot;: &quot;65px&quot;, &quot;scaleX&quot; : 1.2, &quot;scaleY&quot; : 1.2}"
                                        data-parallax-options="{&quot;ease&quot;: &quot;linear&quot;, &quot;start&quot;: &quot;top bottom&quot;, &quot;end&quot;: &quot;bottom+=0px top&quot;}"
                                        data-parallax-to="{&quot;x&quot;: &quot;0px&quot;, &quot;y&quot;: &quot;0px&quot;, &quot;scaleX&quot; : 1, &quot;scaleY&quot; : 1}">
                                        <img alt="3D Shape circle" height="34"
                                            src="assets/images/demo/start-hub-2/3D/circle.svg" width="34">
                                    </div>
                                </div>
                            </div>
                            <div class="w-60percent flex flex-col p-15 lg:w-full"
                                ...
                                <div class="w-full flex flex-wrap bg-white rounded-10 shadow-md transition-all">
                                    <div class="w-33percent sm:w-full">
                                        <div
                                            class="flex flex-col border-right border-black-10 pt-45 px-30 pb-60 sm:border-right-0 sm:border-bottom animation-element">
                                            <div class="ld-fancy-heading relative">
                                                <h2 class="ld-fh-element ld-gradient-heading relative bg-transparent mb-0/5em"
                                                    style="background-image: linear-gradient(180deg, #4452F2 0%, #F2DFDF 100%);">
                                                    6+</h2>
                                            </div>
                                            <div class="ld-fancy-heading relative">
                                    ...
                                    <div class="w-33percent sm:w-full">
                                        <div class="flex flex-col pt-45 px-30 pb-60 animation-element">
                                            ...
                                            <div class="ld-fancy-heading relative">
                                                <h6 class="ld-fh-element relative mb-2em">Course Options</h6>
                                            </div>
                                            <div class="ld-fancy-heading relative">
                                                <p
                                                    class="ld-fh-element mb-0/5em inline-block relative text-16 leading-1/6em">
                ...
                <section class="lqd-section clients py-30"
                    data-ca-options="{&quot;animationTarget&quot;: &quot;p, .animation-element&quot;, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;45px&quot;, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;opacity&quot; : 1}}"
                    data-custom-animations="true" id="clients">
                    <div class="container p-0">
                        <div class="row m-0">
                            ...
                            <div class="col col-12 p-0"
                                data-ca-options="{&quot;animationTarget&quot;: &quot;img&quot;, &quot;duration&quot; : 1800, &quot;delay&quot; : 120, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;scaleX&quot; : 1.3, &quot;scaleY&quot; : 1.3, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;scaleX&quot; : 1, &quot;scaleY&quot; : 1, &quot;opacity&quot; : 1}}"
                                data-custom-animations="true">
                                <div class="py-35 px-10 border-1 border-black-10 rounded-4 animation-element">
                                    <div class="container-fluid">
                                        <div class="row items-center">
                                            <div class="col col-6 col-md-2 text-center p-10 module-col"><img
                                                    alt="html" height="23"
                                                    src="assets/images/demo/start-hub-2/3D/html.png" width="75">
                                            </div>
                                            <div class="col col-6 col-md-2 text-center p-10 module-col"><img
                                                    alt="css" height="23"
                                                    src="assets/images/demo/start-hub-2/3d/css.png" width="65">
                                            </div>
                                            <div class="col col-6 col-md-2 text-center p-10 module-col"><img
                                                    alt="php" height="17"
                                                    src="assets/images/demo/start-hub-2/3d/php.png" width="75">
                                            </div>
                                            <div class="col col-6 col-md-2 text-center p-10 module-col"><img
                                                    alt="java" height="19"
                                                    src="assets/images/demo/start-hub-2/3d/java.png" width="73">
                                            </div>
                                            <div class="col col-6 col-md-2 text-center p-10"><img alt="python"
                                                    height="25" src="assets/images/demo/start-hub-2/3d/python.png"
                                                    width="85"></div>
                                            <div class="col col-6 col-md-2 text-center p-10"><img alt="c++"
                                                    height="36" src="assets/images/demo/start-hub-2/3d/cplus.png"
                                                    width="74"></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="lqd-section testimonials pt-90 pb-130 bg-transparent transition-all z-1 relative"
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col col-12 col-xl-4 module-col"
                                ...
                                data-custom-animations="true">
                                <div
                                    class="mb-30 iconbox flex flex-grow-1 relative flex-wrap items-center animation-element">
                                    <div class="iconbox-icon-wrap mr-5">
                                        <div
                                            class="iconbox-icon-container inline-flex relative z-1 rounded-full text-20 w-40 h-40 text-blue-300 bg-blue-100">
                                            <svg class="w-1em absolute-center" viewbox="0 0 512 512"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <h3 class="lqd-iconbox-heading text-18 font-normal text-dark m-0"><strong>—
                                            97.6</strong> <span>&nbsp;&nbsp;Customer Satisfaction</span></h3>
                                    <p></p>
                                </div>
                                ...
                                <div class="ld-fancy-heading relative inline-block">
                                    <h2 class="ld-fh-element relative ld-gradient-heading text-36 bg-transparent leading-1/15em mr-0/2em mb-0 ml-0/2em"
                                        style="background-image: linear-gradient(0deg, #749FEF 0%, #4452F2 100%);">
                                        happy</h2>
                                </div>
                                <div class="ld-fancy-heading relative inline-block">
                            ...
                            <div class="col col-12 col-xl-8 relative"
                                ...
                                <div class="ml-5percent lg:m-0">
                                    <div class="lqd-imggrp-single block absolute -top-10percent z-1"
                                        data-float="ease">
                                        <div
                                            class="w-50percent lqd-imggrp-img-container inline-flex relative items-center justify-center">
                                            <figure class="w-full relative animation-element"><img alt="shape"
                                                    height="181"
                                                    src="assets/images/demo/start-hub-2/3D/Image-748.png"
                                                    width="186"></figure>
                                        </div>
                                    </div>
                                    <div class="carousel-container lqd-carousel-stack animation-element">
                                        <div class="carousel-items"
                                            data-lqd-flickity="{ &quot;watchCSS&quot;:  true }">
                                            <div class="carousel-item w-full"><span
                                                    class="lqd-carousel-handle"></span>
                                                <div
                                                    ...
                                                    <div class="icon-text-nightblue flex justify-center mb-4">
                                                        <ul
                                                            class="lqd-star-rating lqd-star-rating-shaped lqd-star-rating-outline">
                                                            <li>
                                                                <svg class="active" style="width: 1em; height: 1em;"
                                                                    viewbox="0 0 576 512"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            class="lqd-testi-details flex items-center justify-center">
                                                            <figure
                                                                class="lqd-testi-avatar rounded-full overflow-hidden">
                                                                <img alt="Ray Charles" class="rounded-full"
                                                    ...
                                                    <div class="lqd-testi-extra pt-1/5em mt-1/5em">
                                                        <figure><img alt="Ray Charles"
                                                                src="assets/images/demo/start-hub-2/logo/logo1.png">
                                                        </figure>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item w-full"><span
                                                    class="lqd-carousel-handle"></span>
                                                <div
                                                    class="lqd-testi relative lqd-testi-style-18 pt-2/5em pb-1/5em lqd-testi-shadow-sm2 lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-68 text-center module-line-2">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <figure
                                                                class="lqd-testi-avatar rounded-full overflow-hidden">
                                                                <img alt="Markfortez" class="rounded-full"
                                                                    src="assets/images/demo/start-hub-2/testimonial/Image-2.jpg">
                                                            </figure>
                                                            <div class="lqd-testi-np text-start pl-1/5em">
                                                                <h3 class="uppercase tracking-0/1em font-bold">
                                                                    Fara Sadgirl</h3>
                                                                <h4>Siswi SMK</h4>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="carousel-item w-full"><span
                                                    class="lqd-carousel-handle"></span>
                                                <div
                                                    class="lqd-testi relative lqd-testi-style-18 pt-2/5em pb-1/5em lqd-testi-shadow-sm2 lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-68 text-center module-line-3">
                                                    <div class="flex justify-center mb-4">
                                                        <ul
                                                            class="lqd-star-rating lqd-star-rating-shaped lqd-star-rating-outline">
                                                            <li>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <figure
                                                                class="lqd-testi-avatar rounded-full overflow-hidden">
                                                                <img alt="Divinginwonderland" class="rounded-full"
                                                                    src="assets/images/demo/start-hub-2/testimonial/image.jpg">
                                                            </figure>
                                                            <div class="lqd-testi-np text-start pl-1/5em">
                                                                <h3 class="uppercase tracking-0/1em font-bold">
                                                                    Divinginwonderland</h3>
                                                                <h4>Envato User</h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="lqd-testi-extra pt-1/5em mt-1/5em">
                                                        <figure><img alt="Divinginwonderland"
                                                                src="assets/images/demo/start-hub-2/logo/logo1.png">
                                                        </figure>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="carousel-item w-full"><span
                                                    class="lqd-carousel-handle"></span>
                                                <div
                                                    class="lqd-testi relative lqd-testi-style-18 pt-2/5em pb-1/5em lqd-testi-shadow-sm2 lqd-testi-details-sm lqd-testi-quote-18 lqd-testi-avatar-68 text-center module-line-4">
                                                    <div class="flex justify-center mb-4">
                                                        <ul
                                                            class="lqd-star-rating lqd-star-rating-shaped lqd-star-rating-outline">
                                                            <li>
                                                    ...
                                                    <div class="lqd-testi-quote mb-1/5em px-1em">
                                                        <blockquote>
                                                            <p><span style="font-weight: 500;"><span>I would give
                                                                        LiquidThemes are five stars for each category if
                                                                        I could! I LOVE the demo site I was able to
                                                                        easily download and customize -</span> <span
                                                                        style="color: #638293;">I'm going to have the
                                                                        best portfolio site ever! Yay
                                                                        microinteractions!</span></span>
                                                            </p>
                                                        </blockquote>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <figure
                                                                class="lqd-testi-avatar rounded-full overflow-hidden">
                                                                <img alt="Brukmaxwell" class="rounded-full"
                                                                    src="assets/images/demo/start-hub-2/testimonial/image-3.jpg">
                                                            </figure>
                                                            <div class="lqd-testi-np text-start pl-1/5em">
                                                                <h3 class="uppercase tracking-0/1em font-bold">
                                                                    Brukmaxwell</h3>
                                        ...
                                        <div class="lqd-carousel-stack-nav">
                                            <button
                                                class="lqd-carousel-stack-btn lqd-carousel-stack-prev rounded-100">
                                                <svg height="10" viewbox="0 0 6 10" width="6"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M5.863 8.387L4.75 9.5L0 4.75L4.75 0L5.863 1.113L2.229 4.75L5.863 8.387Z">
                                                    </path>
                                                </svg>
                                            </button>
                                            <button
                                                class="lqd-carousel-stack-btn lqd-carousel-stack-next rounded-100">
                                                <svg height="10" viewbox="0 0 6 10" width="6"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M-2.43187e-05 8.387L1.11298 9.5L5.86298 4.75L1.11298 0L-2.43187e-05 1.113L3.63398 4.75L-2.43187e-05 8.387Z">
                                                    </path>
                                                </svg>
                                            </button>
                                        </div>
                ...
                <section class="lqd-section blog py-90 bg-transparent transition-all"
                    ...
                    <div class="container">
                        <div class="row items-center">
                            <div class="col col-12 col-md-6 animation-element">
                                <div class="mb-15 ld-fancy-heading relative">
                                    <h6
                                        class="ld-fh-element m-0 inline-block relative label text-10 tracking-1 uppercase font-bold text-black bg-blue-200 trackink-1px py-5 px-15 rounded-100">
                                        Kenal lebih dekat</h6>
                                </div>
                                <div class="ld-fancy-heading relative">
                            ...
                            <div class="col col-12 col-md-6 animation-element">
                                <div class="ld-fancy-heading relative">
                                    <p
                                        class="ld-fh-element mb-0/5em inline-block relative leading-1/6em text-18 text-gray-500">
                                                ...
                                                <div class="card swiper-slide">
                                                    <div class="image-content">
                                                        ...
                                                        <div class="card-image">
                                                            <img src="{{ asset('uploaded_files/' . $playlist->image) }}"
                                                                alt="" class="card-img">
                                                        </div>
                                                    </div>
                        ...
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img src="assets/images/demo/start-hub-2/img/profile2.jpg" alt="" class="card-img">
                            </div>
                        </div>

                        <div class="card-content">
                            <h2 class="name">Dina Belakang Alfamart</h2>
                    ...
                    <div class="card swiper-slide">
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img src="assets/images/demo/start-hub-2/img/profile3.jpg" alt="" class="card-img">
                            </div>
                        </div>

                        <div class="card-content">
                            <h2 class="name">Mustofa Servis AC</h2>
                            <p class="description">The lorem text the section that contains header with having open functionality. Lorem dolor sit amet consectetur adipisicing elit.</p>
                    ...
                    <div class="card swiper-slide">
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img src="assets/images/demo/start-hub-2/img/profile4.jpg" alt="" class="card-img">
                            </div>
                        </div>

                        <div class="card-content">
                            <h2 class="name">David Warung Madura</h2>
                            <p class="description">The lorem text the section that contains header with having open functionality. Lorem dolor sit amet consectetur adipisicing elit.</p>
                    ...
                    <div class="card swiper-slide">
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img src="assets/images/demo/start-hub-2/img/profile5.jpg" alt="" class="card-img">
                            </div>
                        </div>

                        <div class="card-content">
                            <h2 class="name">Henri Jalan Kenanga</h2>
                            <p class="description">The lorem text the section that contains header with having open functionality. Lorem dolor sit amet consectetur adipisicing elit.</p>
                            ...
                            {{-- <div class="col col-12 text-center animation-element">
                                <div class="flex flex-row flex-wrap items-center justify-center">
                                    <div class="mr-25 ld-fancy-heading relative sm:mr-0">
                                        <h6
                                            class="ld-fh-element m-0 inline-block relative label text-purple-500 font-normal bg-purple-100 text-15 font-normal py-5 px-15 rounded-100">
                                            Contact</h6>
                                    </div>
                                    <div class="ld-fancy-heading relative">
                                        <p class="ld-fh-element relative m-0 text-14 text-purple-700"><span>Looking
                                                for a corporate solution?</span>
                                            <a data-localscroll="true" href="#contact"><u
                                                    class="text-purple-500">Contact
                                                    us.</u></a>
                                        </p>
                                    </div>
                                </div>
                ...
                <section class="lqd-section connect-top pt-10 relative">
                    ...
                    {{-- <div class="container">
                        <div class="row">
                            <div class="col col-12 text-center"
                                data-ca-options="{&quot;animationTarget&quot;: &quot;h2, p, .btn&quot;, &quot;ease&quot;: &quot;power4.out&quot;, &quot;initValues&quot;: {&quot;y&quot;: &quot;45px&quot;, &quot;rotationY&quot; : 65, &quot;opacity&quot; : 0} , &quot;animations&quot;: {&quot;y&quot;: &quot;0px&quot;, &quot;rotationY&quot; : 0, &quot;opacity&quot; : 1}}"
                                data-custom-animations="true">
                                <div class="ld-fancy-heading relative">
                                    <h2 class="ld-fh-element relative heading-title lqd-highlight-custom lqd-highlight-custom-2 text-46 mb-0/75em text-gray-600"
                                        data-delay-options="{&quot;elements&quot;: &quot;.lqd-highlight-inner&quot;, &quot;delayType&quot;: &quot;transition&quot;}"
                                        data-inview="true" data-transition-delay="true">
                                        <span>Have a project in mind? Let's </span>
                                        <mark class="lqd-highlight"><span class="lqd-highlight-txt">connect</span>
                                            <span class="lqd-highlight-inner bottom-0 left-0"><svg
                                                    class="lqd-highlight-pen" height="51" viewbox="0 0 51 51"
                                                    width="51" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M36.204 1.044C32.02 2.814 5.66 31.155 4.514 35.116c-.632 2.182-1.75 5.516-2.483 7.409-3.024 7.805-1.54 9.29 6.265 6.265 1.893-.733 5.227-1.848 7.41-2.477 3.834-1.105 4.473-1.647 19.175-16.27 0 0 10.63-10.546 15.21-15.125C53 8.997 42.021-1.418 36.203 1.044Zm7.263 5.369c3.56 3.28 4.114 4.749 2.643 6.995l-1.115 1.7-4.586-4.543-4.585-4.544 1.42-1.157C39.311 3.18 40.2 3.4 43.467 6.413ZM37.863 13.3l4.266 4.304-11.547 11.561-11.547 11.561-4.48-4.446-4.481-4.447 11.404-11.418c6.273-6.28 11.566-11.42 11.762-11.42.197 0 2.277 1.938 4.623 4.305ZM12.016 39.03l3.54 3.584-3.562 1.098-5.316 1.641c-1.665.516-1.727.455-1.211-1.21l1.614-5.226c1.289-4.177.685-4.191 4.935.113Z">
                                                    </path>
                                                </svg> <svg aria-hidden="true"
                                                    class="lqd-highlight-brush-svg lqd-highlight-brush-svg-2"
                                                    height="13" preserveaspectratio="none" viewbox="0 0 233 13"
                                                    width="233" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="m.624 9.414-.312-2.48C0 4.454.001 4.454.002 4.454l.035-.005.102-.013.398-.047c.351-.042.872-.102 1.557-.179 1.37-.152 3.401-.368 6.05-.622C13.44 3.081 21.212 2.42 31.13 1.804 50.966.572 79.394-.48 113.797.24c34.387.717 63.927 2.663 84.874 4.429a1048.61 1048.61 0 0 1 24.513 2.34 641.605 641.605 0 0 1 8.243.944l.432.054.149.02-.318 2.479-.319 2.48-.137-.018c-.094-.012-.234-.03-.421-.052a634.593 634.593 0 0 0-8.167-.936 1043.26 1043.26 0 0 0-24.395-2.329c-20.864-1.76-50.296-3.697-84.558-4.413-34.246-.714-62.535.332-82.253 1.556-9.859.612-17.574 1.269-22.82 1.772-2.622.251-4.627.464-5.973.614a213.493 213.493 0 0 0-1.901.22l-.094.01-.028.004Z">
                                                    </path>
                                                </svg></span>
                                ...
                                <div class="mb-25">
                                    <p class="text-18 font-medium leading-1/15em"><span class="text-blue-400">We
                                            have three projects with this Inaama and that is because we love the
                                            design,</span>
                                        <span>the large number of possibilities.</span>
                                    </p>
                                </div>
                                <a class="btn btn-solid btn-hover-txt-liquid-y btn-icon-right btn-hover-reveal rounded-100 bg-transparent py-20 px-50 text-white"
                                    data-lity="#contact-modal" href="#contact-modal"><span class="btn-txt"
                                        data-split-options="{&quot;type&quot;:  &quot;chars, words&quot;}"
                                        data-split-text="true" data-text="Daftar Sekarang">Daftar Sekarang</span>
                                    <span class="btn-icon text-1em"><i aria-hidden="true"
